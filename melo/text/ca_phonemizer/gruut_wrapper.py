...
if __name__ == "__main__":
    ...
    with open('./text/ca_phonemizer/catalan_text.txt', 'r') as f:
        lines = f.readlines()
    ...
    with open('./text/ca_phonemizer/ca_symbols.txt', 'w') as g:
        g.writelines(symbols + not_existed_sym)
        
    with open('./text/ca_phonemizer/example_ipa.txt', 'w') as g:
        g.writelines(phonemes)
        
    data = {'symbols': symbols + not_existed_sym}
    with open('./text/ca_phonemizer/ca_symbols_v2.json', 'w') as f:
